        ...
        <div class="container">
            ...
            <div class="left">
              ...
              <div class="buy text-center">
                <a href="{{route('product-details', $producto->id)}}">
                ...
                <div id="contenedor" class="row_p">
                    ...
                    <div id="verde" class="content_pagos"> 
                        ...
                        <button type="button" class="btnwssp btn btn-outline-success btn-lg">
                            <a target="none" href="https://wa.me/73455844?text=Hola%2CEstoy+interesad%40+en+la+oferta%3A+{{$oferta->titulo}}">
                               Preguntar
                            </a>
                        </button> 
                    </div>
